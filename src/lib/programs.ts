...
export const programs: Program[] = [
	...
	},
	{
		...
		description:
			'Middle School students will work on their own RC aircraft project over five in-person sessions, guided by our mentors. Students will learn how to use the engineering process in groups to create control surfaces and electrical circuits, ultimately gaining valuable understanding in fundamental physics, flight mechanics, and circuit design.',
		location: 'West Valley Branch Library (1243 San Tomas Aquino Rd, San Jose, CA 95117)',
		time: 'TBD',
	...
	},
	{
		...
		description:
			'This program is open to those who will be in middle school for the 2024-2025 school year. Students will learn mechanical and electrical engineering concepts. Their final project will be to build their own RC car in small groups.',
	...
	},
	{
		...
		albumLink:
			'https://drive.google.com/drive/folders/1cF8x66qj9Y_IDXeCeWy7x2lDJCy4F2qd?usp=sharing',
		pastProgram: true
	}
];
